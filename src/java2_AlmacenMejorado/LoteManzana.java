...
public class LoteManzana {
	
	private ArrayList <Manzana> arrayManzana = new ArrayList <Manzana> ();
	...
	public void pedirManzanas() {
		...
		System.out.print("Introduce el número de manzanas a introducir: ");
		int num = sc.nextInt();
	...
	public final void mostrarManzanas() {
		...
		for(int mm=0; mm<arrayManzana.size(); mm++) {
			...
			System.out.println("Tipo de manzana: " + arrayManzana.get(mm).getTipo() );
